...
@can('cms_content_metum_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'CmsContentMetum', 'route' => 'admin.cms-content-meta.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-CmsContentMetum">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.cms-content-meta.index') }}",
    columns: [
...
{ data: 'type', name: 'type' },
{ data: 'post_post_title', name: 'post.post_title' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-CmsContentMetum').DataTable(dtOverrideGlobals);
