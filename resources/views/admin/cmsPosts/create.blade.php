...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.cmsPost.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.cms-posts.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_title') ? 'is-invalid' : '' }}" type="text" name="post_title" id="post_title" value="{{ old('post_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_name') ? 'is-invalid' : '' }}" type="text" name="post_name" id="post_name" value="{{ old('post_name', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('post_content') ? 'is-invalid' : '' }}" name="post_content" id="post_content">{!! old('post_content') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('post_date') ? 'is-invalid' : '' }}" type="text" name="post_date" id="post_date" value="{{ old('post_date') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('post_excerpt') ? 'is-invalid' : '' }}" name="post_excerpt" id="post_excerpt">{{ old('post_excerpt') }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('post_status') ? 'is-invalid' : '' }}" name="post_status" id="post_status" required>
                    ...
                    @foreach(App\Models\CmsPost::POST_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('post_status', 'publish') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\CmsPost::COMMENT_STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('comment_status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="comment_status_{{ $key }}" name="comment_status" value="{{ $key }}" {{ old('comment_status', 'close') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_password') ? 'is-invalid' : '' }}" type="text" name="post_password" id="post_password" value="{{ old('post_password', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('thumbnail') ? 'is-invalid' : '' }}" name="thumbnail_id" id="thumbnail_id">
                    @foreach($thumbnails as $id => $entry)
                        <option value="{{ $id }}" {{ old('thumbnail_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
